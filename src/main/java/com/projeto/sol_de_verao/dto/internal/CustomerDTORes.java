...
public class CustomerDTORes implements Serializable {
    ...
    public CustomerDTORes(String name, Boolean credit, TypeCustomer type, Boolean enabled, Date creationDate) {
        this.name = name;
        this.credit = credit;
        this.type = type;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CustomerDTORes that)) return false;
